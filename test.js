...
const getBishopTopLeftPath = (board, currentPos, team, isExtra = false) => {
    ...
    let possibleMoves = []
    while (i <= 7 && j <= 7 && (isFreeBox(board[i][j], team) || isExtra)) {

        possibleMoves.push({ row: i, box: j })
        if (isFreeBox(board[i][j], team) === "eat" || (isExtra && !isFreeBox(board[i][j], team))) {
            break;
        }
        i++;
        j++;
...
const getBishopTopRightPath = (board, currentPos, team, isExtra = false) => {
    ...
    let i = currentPos.row - 1;
    let j = currentPos.box - 1;
    while (i >= 0 && j >= 0 && (isFreeBox(board[i][j], team) || isExtra)) {
...
const getBishopBottomLeftPath = (board, currentPos, team, isExtra = false) => {
    ...
    let i = currentPos.row - 1;
    let j = currentPos.box + 1;
    while (i >= 0 && j <= 7 && (isFreeBox(board[i][j], team) || isExtra)) {
...
const getBishopBottomRightPath = (board, currentPos, team, isExtra = false) => {
    ...
    let i = currentPos.row + 1;
    let j = currentPos.box - 1;
    while (i <= 7 && j >= 0 && (isFreeBox(board[i][j], team) || isExtra)) {
...
const getRockLeftMoves = (board, currentPos, team, isExtra) => {
    ...
    while (i <= 7 && (isFreeBox(board[i][currentPos.box], team) || isExtra)) {
        ...
        if (isFreeBox(board[i][currentPos.box], team) === "eat" || (isExtra && !isFreeBox(board[i][currentPos.box], team))) {
            break;
        }
        i++
    }
...
const getRockBottomMoves = (board, currentPos, team, isExtra) => {
    ...
    while (j >= 0 && (isFreeBox(board[currentPos.row][j], team) || isExtra)) {
        ...
        if (isFreeBox(board[currentPos.row][j], team) === "eat" || (isExtra && !isFreeBox(board[currentPos.row][j], team))) {
...
const getRockMoves = (board, currentPos, team, isExtra = false) => {
...
const isCheckedKing = (board, team, kingPosition) => {
    ...
    const possibleRockMoves = getRockMoves(board, kingPosition, team, true)
    ...
    const possibleBishopMoves = getBishopMoves(board, kingPosition, team, true)
